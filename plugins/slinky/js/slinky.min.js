...
var _extends = Object.assign || function (e) {
    ...
    return _createClass(e, [{
        ...
        key: "_init", value: function (e) {
            ...
            this.base;
            var t = this.menu, i = this.settings;
            ...
            $(".header", t).prepend(s), i.title && $("li > ul", t).each(function (e, t) {
                ...
                if (i) {
                    ///////
                    var href = $($(t).parent().find("a").first()[0]).attr('href');
                    if(href){
                        var n = $("<a href='"+$($(t).parent().find("a").first()[0]).attr('href')+"'>").addClass("title").text(i);
                    } else {
                        var n = $("<div>").addClass("title").text(i);
                    }
                    ////////
                    $("> .header", t).append(n)
                }
        ...
        key: "_addListeners", value: function () {
            var e = this, t = this.menu, i = this.settings;
        ...
        key: "_move", value: function () {
            ...
            if (0 !== e) {
                var i = this.settings, n = this.base, s = Math.round(parseInt(n.get(0).style.left)) || 0;
        ...
        key: "_transition", value: function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 300, t = this.menu, i = this.base;
        ...
        key: "jump", value: function (e) {
            ...
            if (e) {
                var i = this.menu, n = this.settings, s = $(e), a = i.find(".active"), r = 0;
        ...
        key: "home", value: function () {
            var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0], t = this.base, i = this.menu,
                n = this.settings;
            e || this._transition(0);
            var s = i.find(".active"), a = s.parentsUntil(i, "ul");
